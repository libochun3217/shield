package com.example.shield_demo.shield.basicfeatureandclick;
...
public class ClickAgentConfig implements AgentListConfig {
    private static final String AGENT_PKG_NAME = "com.example.shield_demo.shield.basicfeatureandclick.agent.";
