package com.example.shield_demo.shield.headerfootercell;
...
public class HeaderFooterCellAgentConfig implements AgentListConfig {
    private static final String AGENT_PKG_NAME = "com.example.shield_demo.shield.headerfootercell.agent.";
